...
type Promotion struct {
	...
	TargetType         string         `json:"target_type" gorm:"type:varchar(32);not null;default:'all'"` // all, product, tech_card, category
	TargetIDs          []uuid.UUID    `json:"target_ids,omitempty" gorm:"type:jsonb;serializer:json;default:'[]'"`
