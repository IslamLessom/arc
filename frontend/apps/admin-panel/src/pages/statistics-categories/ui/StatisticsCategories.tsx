    ...
    <Styled.PageContainer>
      <Styled.Header>
        <Styled.HeaderLeft>
          ...
          <Styled.Title>Статистика - Категории</Styled.Title>
        </Styled.HeaderLeft>
      ...
      <Styled.CardsGrid>
        <Styled.StatCard>
          ...
          <Styled.CardContent>
            <Styled.CardLabel>Всего категорий</Styled.CardLabel>
        ...
        <Styled.StatCard>
          ...
          <Styled.CardContent>
            <Styled.CardLabel>Товаров в категориях</Styled.CardLabel>
            <Styled.CardValue>0</Styled.CardValue>
          </Styled.CardContent>
        </Styled.StatCard>
        ...
        <Styled.StatCard>
          <Styled.CardIcon>💰</Styled.CardIcon>
          <Styled.CardContent>
            <Styled.CardLabel>Выручка по категориям</Styled.CardLabel>
            <Styled.CardValue>0 ₽</Styled.CardValue>
          </Styled.CardContent>
        </Styled.StatCard>
        ...
        <Styled.StatCard>
          <Styled.CardIcon>📈</Styled.CardIcon>
          <Styled.CardContent>
            <Styled.CardLabel>Популярная категория</Styled.CardLabel>
      ...
      <Styled.ContentGrid>
        <Styled.ChartSection>
          <Styled.SectionTitle>Распределение по категориям</Styled.SectionTitle>
          <Styled.ChartPlaceholder>
            <Styled.ChartIcon>📊</Styled.ChartIcon>
            <Styled.ChartText>График распределения по категориям</Styled.ChartText>
          </Styled.ChartPlaceholder>
        </Styled.ChartSection>
      ...
      <Styled.DetailsSection>
        <Styled.SectionTitle>Детализация по категориям</Styled.SectionTitle>
        <Styled.DetailsPlaceholder>
          <Styled.DetailsIcon>📁</Styled.DetailsIcon>
          <Styled.DetailsText>Детальная информация о категориях</Styled.DetailsText>
        </Styled.DetailsPlaceholder>
      </Styled.DetailsSection>
    </Styled.PageContainer>
  )
