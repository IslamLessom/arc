...
export const SemiFinishedList = styled.div(({ theme }) => ({
  backgroundColor: theme.colors.background,
  borderRadius: theme.borderRadius.lg,
  border: `1px solid ${theme.colors.border}`,
  overflow: 'hidden',
...
export const SemiFinishedName = styled.span(({ theme }) => ({
  fontSize: '14px',
  color: theme.colors.textPrimary,
  fontWeight: 500,
}))

export const SemiFinishedCategory = styled.span(({ theme }) => ({
  fontSize: '14px',
  color: theme.colors.textSecondary,
}))

export const SemiFinishedUnit = styled.span(({ theme }) => ({
  fontSize: '14px',
  color: theme.colors.textSecondary,
}))

export const SemiFinishedQuantity = styled.span(({ theme }) => ({
  fontSize: '14px',
  color: theme.colors.textPrimary,
  fontWeight: 500,
}))

export const SemiFinishedCost = styled.span(({ theme }) => ({
  fontSize: '14px',
  color: theme.colors.textPrimary,
  fontWeight: 600,
}))

export const SemiFinishedActions = styled.div(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing.sm,
  alignItems: 'center',
}))
